...
const Features = () => {
    ...
    const features = [
        ...
        {
            icon: <FaCartShopping className="text-red-400 text-4xl"/>,
            title: "Free Delivery",
            description: "Get your order delivered,at no extra cost, fast and hassle free."
        },
        {
        ...
        {
            icon: <BsFillShieldLockFill className="text-red-400 text-4xl"/>,
